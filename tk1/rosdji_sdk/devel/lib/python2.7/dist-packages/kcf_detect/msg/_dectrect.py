...
"""autogenerated by genpy from kcf_detect/dectrect.msg. Do not edit."""
import sys
...
class dectrect(genpy.Message):
  _md5sum = "13860a6b7a8df7b796f4eac3c5475ca0"
  _type = "kcf_detect/dectrect"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(dectrect, self).__init__(*args, **kwds)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.w = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.h = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
