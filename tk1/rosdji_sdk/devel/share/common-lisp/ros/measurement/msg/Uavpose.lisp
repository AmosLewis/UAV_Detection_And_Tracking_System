...
(cl:defmethod cl:initialize-instance :after ((m <Uavpose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Uavpose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name measurement-msg:<Uavpose> is deprecated: use measurement-msg:Uavpose instead.")))

(cl:ensure-generic-function 'uav_roll-val :lambda-list '(m))
(cl:defmethod uav_roll-val ((m <Uavpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader measurement-msg:uav_roll-val is deprecated.  Use measurement-msg:uav_roll instead.")
  (uav_roll m))

(cl:ensure-generic-function 'uav_pitch-val :lambda-list '(m))
(cl:defmethod uav_pitch-val ((m <Uavpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader measurement-msg:uav_pitch-val is deprecated.  Use measurement-msg:uav_pitch instead.")
  (uav_pitch m))

(cl:ensure-generic-function 'uav_yaw-val :lambda-list '(m))
(cl:defmethod uav_yaw-val ((m <Uavpose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader measurement-msg:uav_yaw-val is deprecated.  Use measurement-msg:uav_yaw instead.")
  (uav_yaw m))
